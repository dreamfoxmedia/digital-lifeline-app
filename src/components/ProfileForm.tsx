    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-4 py-3.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1a1a24] text-gray-900 dark:text-white text-base focus:outline-none focus:ring-2 focus:ring-[#FFB454] appearance-none"
        >
      ...
      <div className="flex items-center justify-between py-2">
        ...
        <button
          ...
          className={`relative w-12 h-6 rounded-full transition-colors ${data.notify_emergency ? 'bg-[#FFB454]' : 'bg-gray-300 dark:bg-gray-600'}`}
        >
          <span
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm font-medium border transition-all ${
                  active
                    ? 'bg-[#FFB454] border-[#FFB454] text-white'
